...
public class RoleMapperTest {
    ...
    public void testCache(){
        //查询一个id为1的数据，可见第二次查询其实是查询到了缓存里面
        RoleMapper mapper = sqlSession.getMapper(RoleMapper.class);
        SysRole sysRole = mapper.selectById(1L);
        System.out.println(sysRole);
        sysRole.setRoleName("testaaa");
        ...
        RoleMapper mapper1 = session.getMapper(RoleMapper.class);
        SysRole sysRole2 = mapper1.selectById(1L);
        System.out.println(sysRole2);

        System.out.println(sysRole == sysRole2);
    }
